var talents = {
	...
	"Poultice & Patience"   : "When you have time to prepare and work carefully, you may fully heal another character, removing all Conditions. The healing takes at least an hour (GMs discretion) and cannot be used on yourself. It must be done outside combat and you can only work on one recipient at a time.",
	"Emergency Patch"       : "When using Physick to treat a Critical Injury or Panic, you can remove a number of Wound or Strain Points equal to 2 per the number of Successes you roll instead of 1.",
